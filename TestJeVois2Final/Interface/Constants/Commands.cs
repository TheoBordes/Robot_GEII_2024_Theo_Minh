...
#pragma warning disable CS1591
        ...
        R2PC_PositionAbsolueAndGhostAndWaypoint = 0x014D,               //Timestamp(4L) - X(4F) - Y(4F) - Theta(4F) - Vx(4F) - Vy(4F) - VTheta(4F) - XGhost(4F) - YGhost(4F) - ThetaGhost(4F) - XWayPoint(4F) - YWayPoint(4F) - ThetaWayPoint(4F)
        R2PC_PositionAbsolue = 0x014E,                                  //Timestamp(4L) - X(4F) - Y(4F) - Theta(4F) 
        R2PC_SpeedPolarAndIndependantOdometryAndIMUWithKalman = 0x014F,           //Timestamp(4L) - Vx(4F) - Vy(4F) - VTheta(4F) - VM1(4F) - VM2(4F) - VM3(4F) - VM4(4F) - AccX(4F) - AccY(4F) - AccZ(4F) - GyroX(4F) - GyroY(4F) - GyroZ(4F)
        R2PC_SpeedPolarAndIndependantOdometryWithKalman = 0x0150,                 //Timestamp(4L) - Vx(4F) - Vy(4F) - VTheta(4F) - VM1(4F) - VM2(4F) - VM3(4F) - VM4(4F)
        ...
        R2PC_MotorPositionOnGhostError = 0x016E,                             //Motor1CurrentPosition(4F),Motor2CurrentPosition(4F),Motor3CurrentPosition(4F),Motor4CurrentPosition(4F),Motor5CurrentPosition(4F),Motor6CurrentPosition(4F),Motor7CurrentPosition(4F),Motor8CurrentPosition(4F), Flags(1 byte)
        R2PC_IndividualMotorPosition = 0x016F,                             //nbMotor(1 Byte) - Motor1CurrentPosition(4F)

        //Retour des commandes d'enable du PC
        R2PC_IndividualMotorEnableDisableStatus = 0x017E,                 //MotorNum (1 Byte) - EnableDisable (1 Byte)
        ...
        R2PC_AsservissementMotorModeStatus = 0x018C,                       //Enable-Disable (1 Byte)
        ...
        PC2R_MotorSpeedToPercent = 0x0247,                              //MotorNumber (1 Byte) - SpeedToPercent (4F)

        PC2R_SetSpeedAsservissementMode = 0x0250,                             //Mode (1 Byte : Disabled=0 - Polarie = 1 - Independant = 2)
        ...
        PC2R_IndividualMotorSetAsservissementMode = 0x0259,             //Numero Moteur (1 byte) - Mode (1 Byte : Disabled=0 Enabled=1)
        PC2R_IndividualMotorSpeedPIDReset = 0x025A,                     //Numero Moteur (1 byte) 
        PC2R_IndividualMotorSetTrajectoryParameters = 0x025B,          //Numero Moteur (1 byte) - accelMax(4F) - vitesseMax(4F) : total 9 octets
        PC2R_IndividualMotorSetTargetPosition = 0x025C,                 //Numero Moteur (1 byte) - targetPosition(4F) : total 5 octets
        PC2R_IndividualMotorSetPidPositionParameters = 0x025D,          //Numero Moteur (1 byte) - Kp(4F) - Ki(4F) - Kd(4F) - LimitPM(4F), LimitIM(4F), LimitDM(4F) : total 25 octets
        ...
        //PC2R_Motor8PIDSetGains = 0x0269,                                //
        PC2R_IndividualMotorPIDSetGains = 0x0266,                       //Numero Moteur (1 byte) - Kp(4F) - Ki(4F) - Kd(4F) - LimitP(4F) - LimitI(4F) - LimitD(4F) : total 25 octets
        PC2R_IndividualMotorSetPointToPositionConstant = 0x0267,        //Numero Moteur (1 byte) - constant(4F) : total 5 octets
        PC2R_PositionPIDReset = 0x0268,
        PC2R_IndividualMotorSetGhostErrorMax = 0x0269,
        PC2R_IndividualMotorGetCurrentPosition = 0x026A,                //Numéro moteur (1 byte)
        ...
        PC2R_TirMove = 0x0274,                                          //4 octets (MSB first) (Periode en µS)
        ...
        PC2R_IMU_SET_REFERENTIAL = 0x02C0,                              //1 byte (XYZ=0, Robocup=1, Eurobot=2)
        PC2R_IMU_SET_OFFSETS = 0x02C1,
        PC2R_USE_C620_ODOMETRIE_INPUT = 0x02C2,                         //1 byte (bool) useC620 Encoder input for odometrie

        PC2R_Position_GNSS = 0x02D0,                                    //X(4F) - Y(4F) - Theta(4F) 
        PC2R_SetForcedLocation = 0x02D1,                                //X(4F) - Y(4F) - Theta(4F) 
        PC2R_SetWayPoint = 0x02D2,                                      //X(4F) - Y(4F) - Theta(4F) 
        PC2R_SetTrajectoryConstants = 0x02D3,                           //accLin(4F) - accRotationCap(4F) - accRotationOrientation(4F) - vLinMax(4F) - vRotationCapMax(4F) - vRotationOrientationMax(4F) 
        PC2R_SetPositionAsservissementMode = 0x02D4,                    //
        PC2R_HolonomicPositionPIDSetGains = 0x02D5,                      //KpX(4F) - KiX(4F) - KdX(4F) - idem en Limit, puis en Y et YLimit, puis en Theta et ThetaLimit
        PC2R_SetKalmanAlphas = 0x02d6,                                  //AlphaTheta(4F) - alphaSpeed(4F) - alphaPosition(4F)
...
#pragma warning restore CS1591
    ...
    public enum AsservissementSpeedMode
    {
        Off4Wheels = 0,
        Polar4Wheels = 1,
    ...
    public enum AsservissementPositionMode
    {
        Off = 0,
        On = 1,
    }
    public enum IndividualAsservissementMode
    {
        ASSERVISSEMENT_OPEN_LOOP = 0,
        ASSERVISSEMENT_SPEED_ENABLED = 1,
        ASSERVISSEMENT_POSITION_ENABLED = 2,
    }
