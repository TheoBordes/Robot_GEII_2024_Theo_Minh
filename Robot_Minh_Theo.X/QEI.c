...
robotState.vitesseBITEAngulaireFromOdometry = (robotState.vitesseDroitFromOdometry - robotState.vitesseGaucheFromOdometry)/DISTROUES;
...
robotState.angleRadianFromOdometry = robotState.vitesseBITEAngulaireFromOdometry ;
